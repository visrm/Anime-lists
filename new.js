function ins() {
    ...
    function ListingAnime(Name) {
        ...
        for (let component of namae) {
            ...
            NewAnimeName = ListedAnime.push(NoN, ALtr, BLtr, CLtr, DLtr, ELtr, FLtr, GLtr, HLtr, ILtr, JLtr, KLtr, LLtr, MLtr,
                NLtr, OLtr, PLtr, QLtr, RLtr, SLtr, TLtr, ULtr, VLtr, WLtr, XLtr, YLtr, ZLtr).join(', ')
        };
        console.log(`The newly added Animes are ${NewAnimeName}`);
    };
